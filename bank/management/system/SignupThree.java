...
public class SignupThree extends JFrame implements ActionListener {
 ...
 SignupThree(String formno){
	 ...
	 type.setFont(new Font("Relway",Font.BOLD,22));
	 ...
	 JLabel number = new JLabel("XXXX-XXXX-XXXX-6788");
	 number.setFont(new Font("Relway",Font.BOLD,22));
	 number.setBounds(330,300,300,30);
	 add(number);
	 
	 JLabel carddetail = new JLabel("(Your 16 Digit Card Number)");
	 carddetail.setFont(new Font("Relway",Font.BOLD,16));
	 ...
	 pnumber.setFont(new Font("Relway",Font.BOLD,22));
	 pnumber.setBounds(330,370,300,30);
	 add(pnumber);
	 
	 JLabel pindetail = new JLabel("(Your 4 Digit Password)");
	 pindetail.setFont(new Font("Relway",Font.BOLD,16));
	 pindetail.setBounds(100,400,300,30);
	 add(pindetail);
	 
	 JLabel services = new JLabel("Services Required:");
	 services.setFont(new Font("Relway",Font.BOLD,22));
	 ...
	 c7 = new JCheckBox("I hereby declare that the information given above and in the enclosed documents is true to the best of my knowledge");
	 c7.setFont(new Font("Relway",Font.BOLD,12));
	 ...
	 submit.setFont(new Font("Relway",Font.BOLD,14));
	 ...
	 cancel.setFont(new Font("Relway",Font.BOLD,14));
